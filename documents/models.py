...
class ContactRole(models.Model):
	...
	"""
	contact = models.ForeignKey(Contact, related_name='document_contact')
...
def post_save_document(instance,sender, **kwardg):
	pc, __ = Contact.objects.get_or_create(user=instance.owner,
										   defaults={"name": instance.owner.username})
	ac, __ = Contact.objects.get_or_create(user=instance.owner,
										   defaults={"name": instance.owner.username}
										   )
	instance.poc = pc

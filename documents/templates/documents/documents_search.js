<script type="text/javascript" charset="utf-8">
	...
	GeoNode.DocumentSearchTable = Ext.extend(Ext.util.Observable, {
		...
		doLayout: function() {
			...
			var tpl = new Ext.Template('<p><b>' + this.titleHeaderText + ':</b> {title}</p>'+ '<p><a href="/documents/{id}">' + this.mapLinkLabelText + '</a></p>');
			...
			var columns = [
				...
				{
					header: this.relatedHeaderText,
					dataIndex: 'related',
					id: 'related',
					renderer: function(value, metaData, record, rowIndex, colIndex, store){
						return '<a href="' + record.get('related_url') + '">' + value + '</a>';
					}
				}];
